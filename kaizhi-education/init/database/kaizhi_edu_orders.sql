...
--
-- Table structure for table `kaizhi_orders`
--

DROP TABLE IF EXISTS `kaizhi_orders`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `kaizhi_orders` (
...
--
-- Dumping data for table `kaizhi_orders`
--
...
--
-- Table structure for table `kaizhi_orders_goods`
--

DROP TABLE IF EXISTS `kaizhi_orders_goods`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `kaizhi_orders_goods` (
...
--
-- Dumping data for table `kaizhi_orders_goods`
--
...
--
-- Table structure for table `kaizhi_pay_record`
--

DROP TABLE IF EXISTS `kaizhi_pay_record`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `kaizhi_pay_record` (
