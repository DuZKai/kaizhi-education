...
public class BigFileTest {
    ...
    public void testChunk() throws IOException {
        ...
        String chunkPath = "C:\\Users\\Administrator\\Desktop\\split_test\\";
    ...
    public void testMerge() throws IOException {
        ...
        //原始文件
        File originalFile = new File("C:\\Users\\Administrator\\Desktop\\1.mp4");
        //合并文件
        File mergeFile = new File("C:\\Users\\Administrator\\Desktop\\1_mix.mp4");
        if (mergeFile.exists()) {
            mergeFile.delete();
        }
        //创建新的合并文件
