...
<!--      <el-form-item label="是否为广告：" prop="isAD">-->
<!--        <el-radio-group v-model="baseInfoData.isAD">-->
<!--          <el-radio :label="true">是</el-radio>-->
<!--          <el-radio :label="false">否</el-radio>-->
<!--        </el-radio-group>-->
<!--      </el-form-item>-->
      <el-form-item label="是否为广告：" prop="isAD">
        <template v-for="item in adTypeData">
          <el-radio :key="item.code" v-model="baseInfoData.isAd" :label="item.code">{{ item.desc }}</el-radio>
        </template>
      </el-form-item>
...
import {COUSE_GRADE_STATUS, COURSE_CHARGE_TYPE_STATUS, COURSE_AD_TYPE_STATUS} from '@/api/constants'
...
export default class extends Vue {
  ...
  private adTypeData: IKVData[] = COURSE_AD_TYPE_STATUS
  //     [
  //   {code: '800001', desc: '否'},
  //   {code: '800002', desc: '是'}
  // ]
  ...
  private rules = {
    ...
    isAd: [{required: true, message: '请选择是否为广告', trigger: 'change'}]
    // price: [
    //   {
    //     required: true,
    //     message: '请正确输入课程价格',
